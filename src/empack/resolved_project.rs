...
mod tests {
    ...
    fn test_confidence_scoring() {
        let low_downloads = ResolvedProject::new("test".to_string(), "Test".to_string(), Platform::Modrinth, 50);
        let high_downloads = ResolvedProject::new("test".to_string(), "Test".to_string(), Platform::Modrinth, 2_000_000);
    ...
    fn test_platform_comparison() {
        let modrinth_project = ResolvedProject::new("test".to_string(), "Test".to_string(), Platform::Modrinth, 1000);
        let curseforge_project = ResolvedProject::new("test".to_string(), "Test".to_string(), Platform::CurseForge, 1000);
