...
/// Shared networking primitive types and behaviors
/// This module defines the interface layer for networking capabilities,
/// while networking/mod.rs handles the actual implementation and orchestration.
...
impl From<crate::networking::NetworkingError> for NetworkingConfigError {
    fn from(err: crate::networking::NetworkingError) -> Self {
        match err {
            ...
            crate::networking::NetworkingError::NoModsProvided => {
                Self::InvalidConcurrency {
