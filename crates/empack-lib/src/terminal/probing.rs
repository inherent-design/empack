...
use crate::primitives::terminal::{
    GraphicsDetectionMethod, ITerm2Caps, KittyGraphicsCaps, SixelCaps, TerminalGraphicsCaps,
};
...
impl CapabilityProber {
    pub fn new(timeout: Duration) -> Result<Self, TerminalError> {
        // Require interactive terminal for probing
    ...
    fn probe_true_color(&self) -> Result<bool, TerminalError> {
        // Test true color support with OSC 11 query
        ...
        F: Fn(&str) -> bool,
    {
        ...
        // The startup force_show_cursor() call in lib.rs is the primary safety
